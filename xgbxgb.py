...
# x_train, x_test, y_train, y_test = model_selection.train_test_split(x_train, y_train, test_size=0.4, random_state=42)
...
#
# print('Error on X_test:  ' + str(rmsle(y_predict, y_test)))
filename = 'output/xgb_result.csv'
df_sub = pd.DataFrame({'id': id_test, 'price_doc': np.exp(y_predict) - 1})
